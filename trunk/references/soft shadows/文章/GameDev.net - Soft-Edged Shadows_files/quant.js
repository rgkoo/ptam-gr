...
function _qcsc(dc,m){
 ...
 if (m=="ad"||d=="doubleclick.net"||d=="atdmt.com"||d=="yieldmanager.com"||d=="fimserve.com"||
  d=="tribalfusion.com"||d=="trafficmp.com"){s+=";fpan=u;fpa=;fpbn=;fpb=";return s;}
...
function quantserve(){
 ...
 var dc="1216980449-8134268-53959199";
 var dg="E4164-W-MO-5";
 var qs="http://pixel.quantserve.com";
 var fp=_qcsc(dc,media);
 ...
 _qimg=new Image();
 _qimg.alt="";
 _qimg.src=qs+'/pixel'+';r='+r+fp+';ns='+ns+';url='+url+';ref='+ref+';ce='+ce+';je='+je+';sr='+sr+';dc='+dc+';dg='+dg+';dst='+dst+';et='+d.getTime()+';tzo='+d.getTimezoneOffset()+';a='+_qacct+qo+qm;
